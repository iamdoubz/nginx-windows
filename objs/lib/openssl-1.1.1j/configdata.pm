...
our %config = (
  ...
  MT => "mt",
  MTFLAGS => [ "-nologo" ],
  PERL => "C:\\Extra\\Strawberry\\perl\\bin\\perl.exe",
  RANLIB => "ranlib",
  RC => "rc",
  RCFLAGS => [  ],
  afalgeng => "",
  ...
  openssldir => "C:\\Users\\dwdoubet\\Gits\\nginx\\objs\\lib\\openssl-1.1.1j/openssl/ssl",
  options => "--prefix=C:\\Users\\dwdoubet\\Gits\\nginx\\objs\\lib\\openssl-1.1.1j/openssl --openssldir=C:\\Users\\dwdoubet\\Gits\\nginx\\objs\\lib\\openssl-1.1.1j/openssl/ssl -D_WIN32_WINNT=0x0501 no-afalgeng no-asan no-asm no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-tests no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "MSWin32-x64-multi-thread",
  perl_cmd => "C:\\Extra\\Strawberry\\perl\\bin\\perl.exe",
  perl_version => "5.32.0",
  perlargv => [ "VC-WIN32", "no-shared", "--prefix=C:\\Users\\dwdoubet\\Gits\\nginx\\objs\\lib\\openssl-1.1.1j/openssl", "--openssldir=C:\\Users\\dwdoubet\\Gits\\nginx\\objs\\lib\\openssl-1.1.1j/openssl/ssl", "no-asm", "no-tests", "-D_WIN32_WINNT=0x0501" ],
  perlenv => {
      "AR" => undef,
      "BUILDFILE" => undef,
      "CC" => undef,
  ...
  prefix => "C:\\Users\\dwdoubet\\Gits\\nginx\\objs\\lib\\openssl-1.1.1j/openssl",
  processor => "",
